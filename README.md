...
`MESH2D` is a simple MATLAB-based Delaunay mesh generator for two-dimensional geometries. It is designed to generate high-quality constrained Delaunay triangulations
...
````
tridemo(1); % explore the impact of the "radius-edge" threshold.
